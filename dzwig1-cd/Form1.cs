  ...
  //  }
    public partial class Form1 : Form
    {
        ...
        private void CheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {  if(id==1 && grab==true)
                {
                    if (ty1==380 && ((tx1 > tx2 - 20 && tx1 < tx2 + 20) || (tx1 > tx3 - 20 && tx1 < tx3 + 20) || (tx1 > tx4 - 20 && tx1 < tx4 + 20)))
                    {
                        draw1 = false;
        ...
        private void CheckBox2_CheckedChanged(object sender, EventArgs e)
       {
        ...
        private void CheckBox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBox3.Checked)
            {
                if (id==2 && grab ==true)
                {
                    if (ty2 == 380 && ((tx2 > tx1 - 20 && tx2 < tx1 + 20) || (tx2 > tx3 - 20 && tx2 < tx3 + 20) || (tx2 > tx4 - 20 && tx2 < tx4 + 20)))
                    {
                        draw2 = false;
                        MessageBox.Show("TU JUŻ STOI INNY TOWAR!");
        ...
        private void CheckBox4_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox4.Checked)
            {
                if (id==3 && grab==true)
                {
                    if (ty3 == 380 && ((tx3 > tx2 - 20 && tx3 < tx2 + 20) || (tx3 > tx1 - 20 && tx3 < tx1 + 20) || (tx3 > tx4 - 20 && tx3 < tx4 + 20)))
                    {
                        draw3 = false;
                        MessageBox.Show("TU JUŻ STOI INNY TOWAR!");
        ...
        private void CheckBox5_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox5.Checked)
            {
                if( id==4 && grab==true)
                {
                    if (ty4 == 380 && ((tx4 > tx2 - 20 && tx4 < tx2 + 20) || (tx4 > tx3 - 20 && tx4 < tx3 + 20) || (tx4 > tx1 - 20 && tx4 < tx1 + 20)))
                    {
                        draw4 = false;
                        MessageBox.Show("TU JUŻ STOI INNY TOWAR!");
